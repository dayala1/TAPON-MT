...
public class LengthLocation extends Feature<Slot>{
	...
	public FeatureValue apply(Slot featurable) {
		...
		if(slotIndex == 0) {
			...
			value = featurable.getEndIndex() - featurable.getStartIndex() - previousSlot.getEndIndex() + previousSlot.getStartIndex();
		}
