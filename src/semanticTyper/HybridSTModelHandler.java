...
public class HybridSTModelHandler{

	final static String NUMERIC_DIRECTORY = "./resources/typerNumericIndex";
	final static String TEXTUAL_DIRECTORY = "./resources/typerTextualIndex";
	...
	private boolean indexDirectoryExists(boolean isNumeric) {
		...
		if (isNumeric) {
			indexDirectory = NUMERIC_DIRECTORY;
		}
		else {
			indexDirectory = TEXTUAL_DIRECTORY;		
		}
